...
def pacientes(request):
    if request.method == "GET":
        ...
        if not idade.isnumeric():
            messages.add_message(request, constants.ERROR, "Idade precisa ser um número")
            return redirect('/pacientes/')
...
def dados_paciente(request, id):
    ...
    if not paciente.nutri == request.user:
        messages.add_message(request, constants.ERROR, "Esse paciente nao e seu")
...
def refeicao(request, id_paciente):
    ...
    if request.method == "POST":
        ...
        carboidratos = request.POST.get('carboidrator')
        ...
        messages.add_message(request, constants.SUCCESS, "Refeicao cadastrada")
